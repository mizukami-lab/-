...
class Encoder(chainer.Chain):
    def __init__(self, in_ch):
        layers = {}
        w = chainer.initializers.Normal(0.02)
        layers['c0'] = L.Convolution2D(in_ch, 16, 3, 1, 1, initialW=w)
        layers['c1'] = CBR(16, 32, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c2'] = CBR(32, 64, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c3'] = CBR(64, 128, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c4'] = CBR(128, 256, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c5'] = CBR(256, 256, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c6'] = CBR(256, 512, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c7'] = CBR(512, 512, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
        layers['c8'] = CBR(512, 512, bn=True, sample='down', activation=F.leaky_relu, dropout=False)
...
class Decoder(chainer.Chain):
    def __init__(self, out_ch):
        ...
        layers['c2'] = CBR(1024, 256, bn=True, sample='up', activation=F.relu, dropout=True)
        layers['c3'] = CBR(512, 256, bn=True, sample='up', activation=F.relu, dropout=True)
        layers['c4'] = CBR(512, 128, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c5'] = CBR(256, 64, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c6'] = CBR(128, 32, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c7'] = CBR(64, 16, bn=True, sample='up', activation=F.relu, dropout=False)
        layers['c8'] = L.Convolution2D(32, out_ch, 3, 1, 1, initialW=w)
